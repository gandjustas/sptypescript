        ...
        context.executeQueryAsync(function (sender, args) {
            ...
            context.executeQueryAsync(function (sender, args) {
                ...
                context.executeQueryAsync(function (sender, args) {
                    ...
                    //}
                }, function (sender, args) { alert("Error operating with services! " + args.get_message()); });
            }, function (sender, args) { alert("Error loading services! " + args.get_message()); });
        }, function (sender, args) { alert("Error loading serviceManager! " + args.get_message()); });
    }, function (sender, args) { alert("Error loading web! " + args.get_message()); });
