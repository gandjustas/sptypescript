module _ {
    function init() {
        CSR.override(105)
            .item((ctx: SPClientTemplates.RenderContext_Form) => {
                var r: string[] = [];
                ...
                var attachmentsField: SPClientTemplates.FieldSchema_InForm;
                ...
                function addFieldHeader(field: SPClientTemplates.FieldSchema_InForm) {
                ...
                function addFieldControl(field: SPClientTemplates.FieldSchema_InForm) {
                    r.push('<td width="350" class="ms-formbody" valign="top">');
                    r.push(ctx.RenderFieldByName(ctx, field.Name));
                    r.push('</td>');
                }

                function addField(field: SPClientTemplates.FieldSchema_InForm) {
