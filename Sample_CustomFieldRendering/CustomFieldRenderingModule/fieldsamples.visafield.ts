module _ {
    module fieldSamples {
        ...
        export class VisaField {
            ...
            private _getVisaValuePart = function(value:string, partIndex:number) {
            ...
            private _wrapIntoInput(renderCtx:SPClientTemplates.RenderContext_Form, val:string, index:number) {
            ...
            private _wrapErrorArea(renderCtx:SPClientTemplates.RenderContext_Form) {
    ...
    class VisaFieldGridEditControl implements SP.JsGrid.IEditControl {
        ...
        public Focus(eventInfo:any): void {
            debugger;
        }
