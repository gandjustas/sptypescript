module _ {
    ...
    function onFailRetrieveGroups(sender:any, args: SP.ClientRequestFailedEventArgs) {
        $('#report').children().remove();
    ...
    // In this case, clear the report area in the page and tell the user what went wrong.
    function onFailListTaxonomySession(sender:any, args: SP.ClientRequestFailedEventArgs) {
        $('#report').children().remove();
    ...
    // In this case, clear the report area in the page and tell the user what went wrong.
    function onFailAddTerms(sender:any, args:SP.ClientRequestFailedEventArgs) {
        $('#report').children().remove();
    ...
    // In this case, clear the report area in the page and tell the user what went wrong.
    function onFailTaxonomySession(sender:any, args: SP.ClientRequestFailedEventArgs) {
        $('#report').children().remove();
        $('#report').append("Failed to get session. Error: " + args.get_message());
    }
